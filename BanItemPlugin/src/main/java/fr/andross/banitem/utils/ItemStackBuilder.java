...
public final class ItemStackBuilder {
    ...
    public ItemStackBuilder(@Nullable final ConfigurationSection section) throws Exception {
        ...
        if (section.contains("amount")) {
            ...
            if (amount <= 0 || amount > 64)
                throw new Exception("&cinvalid amount. Must be superior to 0 and inferior to 64.");
        ...
        if (section.contains("enchantment"))
            for (final String enchant : section.getStringList("enchantment")) {
                ...
                if (ew == null) throw new Exception("&cinvalid enchantment '&e" + enchant + "&c'.");
    ...
    /**
     * Build the item
     * @return the item builded
     */
    @NotNull
    public ItemStack build() {
        final ItemStack clonedStack = itemStack.clone();
        if (itemMeta != null) clonedStack.setItemMeta(itemMeta.clone());
        return clonedStack;
    }
}
