...
public abstract class Utils {
     ...
     */
    @NotNull
    public static List<Integer> getChangedSlots(@NotNull final PlayerInventory inv,
    ...
    /**
     * Get an unmodifiable map of all enchantments on an item,
     * considering stored enchants on enchanted book.
     *
     * @param item the item
     ...
     */
    public static Inventory getClickedInventory(final InventoryView view,
                                                final int slot) {
