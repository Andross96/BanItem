...
public final class Listable {
     ...
     */
    @NotNull
    public static List<String> getSplittedList(@NotNull final String string) {
     ...
     */
    @NotNull
    public static List<String> getSplittedList(@Nullable final List<String> list) {
     ...
     * @param o the object
     * @return a prepared splited list of string
     */
    @NotNull
    public static List<String> getSplittedStringList(@Nullable final Object o) {
        return getSplittedList(getStringList(o));
    }
     ...
     */
    @NotNull
    public static <T> List<T> getList(@NotNull final ListType type, @NotNull final Object obj, @Nullable final Debug d) {
    ...
    public static List<World> getWorlds(@NotNull final Object obj, @Nullable final Debug d) {
        ...
        for (String worldName : strings) {
            ...
            if (remove) worldName = worldName.substring(1);
     ...
     */
    @NotNull
    public static List<BannedItem> getItems(@NotNull final BanDatabase database, @NotNull final Object obj, @Nullable final Debug d) {
        ...
        for (String itemName : strings) {
            ...
            if (itemName.startsWith("#")) {
                ...
                try {
                    ...
                    if (d != null)
                        d.clone().add(ListType.ITEM, "&cInvalid regex synthax &e&l" + itemName + "&c.").sendDebug();
                    continue;
                }
     ...
     */
    @NotNull
    public static List<ProtectedRegion> getRegionsList(@NotNull final BanItem pl, @NotNull final Object obj, @Nullable final Debug d, @NotNull final Collection<World> worlds) {
        ...
        for (String key : strings) {
            ...
            for (final World w : worlds) {
                ...
                if (protectedRegion == null) {
                    ...
                    if (remove) list.remove(protectedRegion);
                    else list.add(protectedRegion);
                }
            }
        }
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    public static <T> T getObject(@NotNull final ListType type, @NotNull final String key) throws IllegalArgumentException {
        switch (type) {
            case WORLD: return (T) Bukkit.getWorld(key);
            case ACTION: return (T) BanAction.valueOf(key.toUpperCase());
            case ITEM: {
    ...
    public static <T> List<T> getAllObjects(@NotNull final ListType type) {
        switch (type) {
            ...
            case ACTION: return (List<T>) Arrays.stream(BanAction.values()).collect(Collectors.toList());
            case ITEM: return (List<T>) Arrays.stream(Material.values()).map(BannedItem::new).collect(Collectors.toList());
            case ENTITY: return (List<T>) Arrays.stream(EntityType.values()).collect(Collectors.toList());
            case ENCHANTMENT:
